...
M550 P"TSE.Big"                                         ; set printer name
...
M569 P2 S1                                              ; physical drive 2 goes forwards (right)
M569 P3 S0                                              ; physical drive 3 goes backwards
M569 P4 S1                                              ; physical drive 4 goes forwards (left)
...
M906 X1500 Y1500 Z2300:2300 E1300 I30                   ; set motor currents (mA) and motor idle factor in per cent
...
M574 Z2 S4                                              ; configure sensorless endstop on hight end of Z
M581 T2 P"e0stop"                                       ; configure E0 as emergency stop
...
M308 S2 P"e1temp" Y"thermistor" T100000 B3950 A"sec-bed" ; configure sensor 2 as thermistor on pin e2temp
M950 H0 C"e0heat" T0 Q10                                ; create bed heater output on e0heat and map it to sensor 0 and set PWM 10Hz
M143 H0 S120                                            ; set temperature limit for heater 0 to 120C

M307 H0 A65.4 C210.5 D1.0 S1.00 V24.4 B0                ; disable bang-bang mode for the nozzle heater and set PWM limit
...
M307 H1 A285 C329.9 D5.0 S1.00 V24.2 B0                 ; disable bang-bang mode for the nozzle heater and set PWM limit
...
M140 H0                                               ; map heater0 and 2 to bed
...
M915 X Y S4 F0 R3 H200 ; configure stall detection on X and Y without Filter (1 Full Steps) and min 200 steps/sec (40mm/sec) (concider motor current 1A) and execute rehome.g on stall
                               ; Coolstep on
M915 Z S2 F0 R1 ; configure stall detection on Z and log it
;M915 P4 S2 F0 R1 ; configure stall detection on Z and log it
...
M671 X-150.0:915.0 Y215.5:215.5 ; Z leadscrews are at (-150,215.5) and (915,215.5)
